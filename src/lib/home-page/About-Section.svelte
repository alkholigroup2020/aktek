...
<section>
	<div class="xl:grid xl:grid-cols-3">
		<div class="max-lg:flex lg:py-12 lg:w-[80%]">
			<div>
				<div>
					<a
						href="/contact-us"
						style="border-radius: 0px !important;"
						class="btn variant-outline bg-secondary-500 w-full shadow-xl"
					>
						<span class="flex-auto py-3 text-white text-sm sm:text-base xl:text-xl"
